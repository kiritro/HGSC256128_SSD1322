...
//Arduino STM32C8T6 Pins
#define OLED_CS1     1  // Pin 1 - CS1 - Chip select
#define OLED_CS2     2  // Pin 2 - CS2 - Chip select
#define OLED_DC      3  // Pin 3 - DC  - digital signal
#define OLED_RESET   0  // Pin 0 - RST - digital signal

//hardware SPI
HGSC256128_SSD1322 display(OLED_DC, OLED_RESET, OLED_CS1 , OLED_CS2);
